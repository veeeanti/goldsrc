...
bool CDiscordRPC::Init(DiscordEventHandlers* handlers)
{
    ...
    Discord_Initialize("1502813555865554974", handlers, 1, nullptr);
    m_bInitialized = true;
    m_bActive = true;
...
void CDiscordRPC::UpdateRicochetStats(int playerFrags, int playerDeaths, bool inMatch)
{
    m_iPlayerFrags = playerFrags;
    m_iPlayerDeaths = playerDeaths;
    m_bInMatch = inMatch;
